...
<script>
    BUI.use('common/main',function(){
        var config = [{id:'1',menu:[{text:'系统管理',items:[
            {id:'1',text:'学生查询',href:'/teacher/stuList.jsp'},
            {id:'2',text:'个人信息管理',href:'/teacher/information.jsp'},
            {id:'3',text:'选择学生',href:'/teacher/choiceStu.jsp'},
            {id:'4',text:'我的学生',href:'/teacher/myStu.jsp'},
            ]}]}];
